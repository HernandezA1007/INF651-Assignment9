...
async function getAllPosts() {
    let response = await fetch("https://jsonplaceholder.typicode.com/posts"); // 100 posts
    let posts = await response.json(); // await posts.json() 
    return posts;
}
...
async function getAllUsers() {
    let response = await fetch("https://jsonplaceholder.typicode.com/users"); // 10 users
...
async function getComments(postId) {
    let response = await fetch(`https://jsonplaceholder.typicode.com/posts/${postId}/comments`); // 500 comments
...
async function getUser(userId) {
    let response = await fetch(`https://jsonplaceholder.typicode.com/users/${userId}`); // gives 10 users - ID
...
async function getTodosForUser(userId) {
    let response = await fetch(`https://jsonplaceholder.typicode.com/users/${userId}/todos`); // 200 todos from users
